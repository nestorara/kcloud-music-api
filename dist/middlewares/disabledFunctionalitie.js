...
exports.disabledFunctionalitie = void 0;
const types_1 = require("../types");
function disabledFunctionalitie(functionality) {
    return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof enabledFunctionality === "boolean" && !enabledFunctionality) {
            res.status(403).json({
                ...
                errorCode: types_1.EerrorCodes.DisabledFunctionalitieError,
            });
        }
        else {
            next();
...
exports.disabledFunctionalitie = disabledFunctionalitie;
exports.default = disabledFunctionalitie;
